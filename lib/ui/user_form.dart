...
import 'package:vision/widget/customButton.dart';
import 'package:vision/widget/myTextField.dart';
...
class _UserFormState extends State<UserForm> {
  ...
  sendUserDataToDB()async{
    ...
    return _collectionRef.doc(currentUser!.email).set({
      ...
      (builder: (_)=>BottomNavBarController()))).catchError((error)=>Fluttertoast.showToast(msg: "something is wrong. $error"));
  }
  @override
